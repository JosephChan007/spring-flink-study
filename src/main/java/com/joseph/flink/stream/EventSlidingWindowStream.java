...
public class EventSlidingWindowStream {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<String> stream = env.socketTextStream("hdfs-host3", 8888).assignTimestampsAndWatermarks(
        ...
        SingleOutputStreamOperator<Tuple2<String, Integer>> nums = stream.map(s -> {
            String[] t = s.split(",");
            return Tuple2.of(t[1], Integer.parseInt(t[2]));
